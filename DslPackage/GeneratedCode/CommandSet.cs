...
namespace UPM_IPS.AFTVFRGGBDERAWebBDs
{
	...
	/// </summary>
	internal partial class AFTVFRGGBDERAWebBDsCommandSet : AFTVFRGGBDERAWebBDsCommandSetBase
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsCommandSet.
		/// </summary>
		public AFTVFRGGBDERAWebBDsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class AFTVFRGGBDERAWebBDsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsCommandSetBase.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewAFTVFRGGBDERAWebBDsExplorerCommand,
				typeof(AFTVFRGGBDERAWebBDsEditorFactory).GUID);
		...
		{
			AFTVFRGGBDERAWebBDsExplorerToolWindow explorer = this.AFTVFRGGBDERAWebBDsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected AFTVFRGGBDERAWebBDsDocData CurrentAFTVFRGGBDERAWebBDsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as AFTVFRGGBDERAWebBDsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected AFTVFRGGBDERAWebBDsDocView CurrentAFTVFRGGBDERAWebBDsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as AFTVFRGGBDERAWebBDsDocView;
			}
		}
		...
		/// </summary>
		protected AFTVFRGGBDERAWebBDsExplorerToolWindow AFTVFRGGBDERAWebBDsExplorerToolWindow
		{
			get
			{
				AFTVFRGGBDERAWebBDsExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(AFTVFRGGBDERAWebBDsExplorerToolWindow), true) as AFTVFRGGBDERAWebBDsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				AFTVFRGGBDERAWebBDsExplorerToolWindow explorerWindow = this.AFTVFRGGBDERAWebBDsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class AFTVFRGGBDERAWebBDsClipboardCommandSet : AFTVFRGGBDERAWebBDsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsClipboardCommandSet.
		/// </summary>
		public AFTVFRGGBDERAWebBDsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class AFTVFRGGBDERAWebBDsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsClipboardCommandSetBase.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}

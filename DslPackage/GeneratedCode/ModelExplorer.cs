...
namespace UPM_IPS.AFTVFRGGBDERAWebBDs
{
	...
	/// </summary>
	internal partial class AFTVFRGGBDERAWebBDsExplorer : AFTVFRGGBDERAWebBDsExplorerBase
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsExplorer.
		/// </summary>
		public AFTVFRGGBDERAWebBDsExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the AFTVFRGGBDERAWebBDsExplorerToolWindow.
	/// </summary>
	internal abstract class AFTVFRGGBDERAWebBDsExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsExplorerBase.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.AFTVFRGGBDERAWebBDsExplorerMenu;
			}
		}
		...
		{
			get { return global::UPM_IPS.AFTVFRGGBDERAWebBDs.ExampleModel.DomainClassId; }
		}

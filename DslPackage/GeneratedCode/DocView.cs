...
namespace UPM_IPS.AFTVFRGGBDERAWebBDs
{
	...
	/// </summary>
	internal partial class AFTVFRGGBDERAWebBDsDocView : AFTVFRGGBDERAWebBDsDocViewBase
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsDocView.
		/// </summary>
		public AFTVFRGGBDERAWebBDsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AFTVFRGGBDERAWebBDsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsDocView.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			AFTVFRGGBDERAWebBDsDocDataBase docData = this.DocData as AFTVFRGGBDERAWebBDsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for AFTVFRGGBDERAWebBDsDocViewBase should be an AFTVFRGGBDERAWebBDsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.AFTVFRGGBDERAWebBDsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);

...
namespace UPM_IPS.AFTVFRGGBDERAWebBDs
{
	...
	/// </remarks>
	public partial class AFTVFRGGBDERAWebBDsToolboxHelper : AFTVFRGGBDERAWebBDsToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsToolboxHelper.
		/// </summary>
		public AFTVFRGGBDERAWebBDsToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class AFTVFRGGBDERAWebBDsToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify AFTVFRGGBDERAWebBDs toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsToolboxHelperBase.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.AFTVFRGGBDERAWebBDs.AFTVFRGGBDERAWebBDsDomainModel));

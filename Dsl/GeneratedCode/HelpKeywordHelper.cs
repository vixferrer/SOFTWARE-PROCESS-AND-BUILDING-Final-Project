...
namespace UPM_IPS.AFTVFRGGBDERAWebBDs
{
	...
	/// </remarks>
	public partial class AFTVFRGGBDERAWebBDsHelpKeywordHelper : AFTVFRGGBDERAWebBDsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsHelpKeywordHelper.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the AFTVFRGGBDERAWebBDsHelpKeywordHelper.
		/// </summary>
		public static AFTVFRGGBDERAWebBDsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class AFTVFRGGBDERAWebBDsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new AFTVFRGGBDERAWebBDsHelpKeywordHelperBase.
		/// </summary>
		protected AFTVFRGGBDERAWebBDsHelpKeywordHelperBase()
			: base() { }
